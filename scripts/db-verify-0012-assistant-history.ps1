...
$queryPath = Join-Path $projectRoot "database\queries\verify_0012_assistant_history.sql"
...
if ($LASTEXITCODE -ne 0) { throw "0012 assistant history verification failed." }
