...
IN = PROJECT_ROOT / "database" / "reference_exports" / "vietnam_acfta_atiga_8703_cbu_rates_ready_round1.csv"
OUT = PROJECT_ROOT / "database" / "seeds" / "0023_vietnam_cbu_acfta_atiga_8703_rates_round1.sql"
